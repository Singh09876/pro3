<%@page import="in.co.rays.project_3.controller.AbcLoginCtl"%>
...
<style type="text/css">
.raj {    
	background-image: linear-gradient(to bottom right,#DDA0DD,white,grey,Cyan, #8A2BE2,grey,grey,grey,grey,#00BFFF);
}
</style>
</head>
<body>
